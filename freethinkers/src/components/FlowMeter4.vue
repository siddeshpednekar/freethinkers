<template>
  <q-page padding>
    <div class="dashboard-container">
      ...
      <div v-if="!zoomedIn">
        <div class="row">
          <div class="col-6">
            ...
            <div class="graph-container">
              <iframe 
                src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=23" 
                width="450" 
                height="200" 
                frameborder="0">
              </iframe>
          ...
          <div class="col-6">
            <div class="graph-container">
              <iframe 
                src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=24" 
                width="450" 
                height="200" 
                frameborder="0">
              </iframe>
        ...
        <div class="row">
          <div class="col-12">
            <div class="graph-container bar-chart-container">
              <BarChart4 ref="BarChart4" />
              <q-icon 
                name="zoom_in" 
                class="zoom-icon"
                @click="zoomIn('BarChart4')" />
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Zoomed-in view -->
      <div v-if="zoomedIn === 'BarChart4'" class="zoomed">
        <BarChart4 />
...
<script>
import BarChart4 from 'src/components/BarChart4.vue';
