...
<q-page padding>
    <div class="dashboard-container">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="graph-container">
                        <iframe src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=22" width="100%" height="200" frameborder="0" title="Flowmeter 1 Graph 1"></iframe>
                    </div>
                    <div class="graph-container">
                        <iframe src="http://localhost:3000/d-solo/cduwn3v3ydcsgd/flowmeter4?orgId=1&from=1682879400000&to=1685557799000&panelId=2" width="100%" height="200" frameborder="0" title="Flowmeter 1 Graph 2"></iframe>
                    </div>
                </div>
                <div class="col-6">
                    <div class="graph-container">
                        <iframe src="http://localhost:3000/d-solo/cduwn3v3ydcsgd/flowmeter4?orgId=1&from=1682879400000&to=1685557799000&panelId=1" width="100%" height="200" frameborder="0" title="Flowmeter 1 Graph 3"></iframe>
        ...
        <div v-if="zoomedIn === 'iframe3'" class="zoomed">
            <iframe src="http://localhost:3000/d-solo/cduwn3v3ydcsgd/flowmeter4?orgId=1&from=1682879400000&to=1685557799000&panelId=1" width="100%" height="100%" frameborder="0" title="Zoomed Flowmeter 1 Graph"></iframe>
