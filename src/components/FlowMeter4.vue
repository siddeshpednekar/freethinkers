  ...
  <q-page padding>
      <div class="dashboard-container">
              ...
              <div class="row">
                  <div class="col-6">
                      <div class="graph-container">
                          <iframe src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=22" width="100%" height="200" frameborder="0">
                          </iframe>
                      </div>
                      <div class="graph-container">
                          <iframe src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=23" width="100%" height="200" frameborder="0">
                          </iframe>
                      </div>
                  </div>
                  <div class="col-6">
                      <div class="graph-container">
                          <iframe src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=24" width="100%" height="200" frameborder="0">
                          </iframe>
          ...
          <div v-if="zoomedIn === 'iframe3'" class="zoomed">
              <iframe src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=24" width="100%" height="100%" frameborder="0">
              </iframe>
