<template>
  <q-page padding>
    <div class="dashboard-container">
      ...
      <div v-if="!zoomedIn">
        <div class="row">
          <div class="col-6">
            ...
            <div class="graph-container">
              <iframe 
                src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=20" 
                width="450" 
                height="200" 
                frameborder="0">
              </iframe>
          ...
          <div class="col-6">
            <div class="graph-container">
              <iframe 
                src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=21" 
                width="450" 
                height="200" 
                frameborder="0">
              </iframe>
        ...
        <div class="row">
          <div class="col-12">
            <div class="graph-container bar-chart-container">
              <BarChart3 ref="BarChart3" />
              <q-icon 
                name="zoom_in" 
                class="zoom-icon"
                @click="zoomIn('BarChart3')" />
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Zoomed-in view -->
      <div v-if="zoomedIn === 'BarChart3'" class="zoomed">
        <BarChart3/>
...
<script>
import BarChart3 from 'src/components/BarChart3.vue';
